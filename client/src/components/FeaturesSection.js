  ...
  return (
    <div className="features-section" data-aos="fade-up">
      ...
      <ul className="features-list">
        <li data-aos="fade-right" data-aos-delay="50">☕ Authentic Dessert Experience</li>
        <li data-aos="fade-right" data-aos-delay="100">🎉 Ideal for Weddings and Events</li>
        <li data-aos="fade-right" data-aos-delay="150">✨ Eye-catching and Sturdy Design</li>
      </ul>
    </div>
  );
}
